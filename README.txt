1. 取扱説明
"g1853671_carpark.tgz"というファイルをダウンロード
ファイルを解凍すると、"g1853671_carpark"というフォルダが展開され、中には"CARPARK.lts"と"Carpark.java","CarparkControl.java","Departures.java","Arrivals.java"と"carpark_g1853671.jar"と"README.txt"というファイルが存在する。
...
3.拡張した点など
・コマンドラインから受け取る値のエラー処理を加えた。
コマンドラインから受け取る値が0以下、もしくは、2つ以上の値であった場合、プログラムを終了するようにした。

・spacesの値をランダムにした。
spacesの値を0以上かつ、駐車場の停車上限値以下の値となるようにした。

・プログラムの最初にcapacityとspacesの値を出力するようにした。
